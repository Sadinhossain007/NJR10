...
fst=f'{dot}[{H}sathi{M}={H}abir{M}={H}tisha{M}={H}sadin{M}={H}samim{P}]'
...
def banner():
  ...
  \033[91;1m  ╔════════════════════════════════════════╗
   ...
   {H} ║{P}[{H}•{P}] Author    :{warna} Sadin Hossain     {N}{H}║

  {H}  ║{P}[{H}•{P}] Facebook  : {H}SADIN HOSSAIN      {N}{H}║

    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801736141997  {N}{H}║
...
def mainx():
    ...
    sadin = input(f'{wt}Select menu {M}:{H} ')
    ...
    if sadin in ["1","01"]:
     ...
     os.system("xdg-open https://www.facebook.com/FB.KING.sadin.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()

    elif sadin in ["0","00"]:

     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.KING.sadin.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.cyber/?ref=share');exit()

    else:

     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/FB.KING.sadin.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
...
def sep():
    ...
    print(led);print(f'{dot}Total File Ids {M}:{H} ' +
          ...
          str(len(open(file_name).read().splitlines())));print(led);print(f'{gen}Example {M}:{H} /sdcard/sadin.txt');print(led)
...
def dupcutter():
    ...
    os.system('clear');banner();print(f'{dot}Example   {RED}:{H} /sdcard/sadin.txt');print(led)

    Error = input(f"{wt}{N}File Name {RED}:{H} ");print(led);print(f'{dot}Example   {RED}:{H} /sdcard/sadin.txt');print(led)
